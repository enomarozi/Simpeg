...
class PegawaiController extends Controller
{
    ...
    public function Detail_pegawai($id){
        $pegawai = DB::table('pegawai')
            ->join('pegawai_agama','pegawai.agama_id','=','pegawai_agama.id')
